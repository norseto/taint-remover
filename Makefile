...
run: manifests generate fmt vet ## Run a controller from your host.
	go run $(LDFLAGS)"-X github.com/norseto/taint-remover.GitVersion=$(GITSHA)" ./cmd/main.go --zap-devel
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --build-arg GITVERSION=$(GITSHA) --provenance=true --sbom=true --tag ${IMG} -f Dockerfile.cross .
